...
class FilemanagerView {
    ...
    public function display() {
      ...
      <script>
        ...
        var dir = "<?php echo (isset($_REQUEST['dir']) ? trim(WDW_S_Library::esc_sanitize_data($_REQUEST, 'dir', 'sanitize_text_field')) : ''); ?>";
        var dirUrl = "<?php echo $this->controller->get_uploads_url() . (isset($_REQUEST['dir']) ? WDW_S_Library::esc_sanitize_data($_REQUEST, 'dir', 'sanitize_text_field') . '/' : ''); ?>";
      ...
      <form id="adminForm" name="adminForm" action="" method="post">
          ...
          <div id="uploader">
            ...
            <label for="jQueryUploader">
              <div id="uploader_hitter">
                ...
                $query_url = add_query_arg(array('action' => 'wds_UploadHandler', 'dir' => (isset($_REQUEST['dir']) ? WDW_S_Library::esc_sanitize_data($_REQUEST, 'dir', 'sanitize_text_field') : '') . '/'), $query_url);
                ?>
        ...
        <input type="hidden" name="dir" value="<?php echo (isset($_REQUEST['dir']) ? str_replace('\\', '', WDW_S_Library::esc_sanitize_data($_REQUEST, 'dir', 'sanitize_text_field')) : ''); ?>" />
